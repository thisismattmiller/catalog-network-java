...
public class CatalogNetwork {
    ...
    public static Boolean linlogmode;
    public static Double edgeweight;
    public static Double scalingratio;
    public static Boolean stronggravity;
    public static Double gravity;
    public static Integer threads;
    public static Boolean bhoptimize;
    public static Double bhtheta;
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        ...
        options.addOption("linlogmode", true, "Use LinLogMod");        
        options.addOption("edgeweight", true, "Edge Weight");        
        options.addOption("scalingratio", true, "Scaling Ration");        
        options.addOption("stronggravity", true, "Use Strong Gravity");
        options.addOption("gravity", true, "Gravity Strength");
        options.addOption("threads", true, "Number of Threads");
        options.addOption("bhoptimize", true, "Barnes Hut Optimize");
        options.addOption("bhtheta", true, "Barnes Hut Theta");
        ...
        try {
            ...
            if( line.hasOption( "help" ) || line.hasOption( "h" ) ) {
                ...
                System.out.println( "-file the path to the gefx file eg -file ../../test.gefx");
                System.out.println( "-linlogmode use lin log mode, boolean eg: -linlogmode true (default true)");
                System.out.println( "-edgeweight edge weight influence, double eg: -edgeweight 1.0 (default 1.0)");
                System.out.println( "-scalingratio node repulsion strength, double eg: -scalingratio 4.0 (default 4.0)");
                System.out.println( "-stronggravity use strong gravity, boolean eg: -stronggravity true (default true)");
                System.out.println( "-gravity gravity strength, double eg: -gravity 0.5 (default 0.02)");
                System.out.println( "-threads how many cpu threads to use, int eg: -threads 8 (default 4)");
                System.out.println( "-bhoptimize use Barnes Hut Optimize allows larger graphs, boolean eg: -bhoptimize true (default true)");
                System.out.println( "-bhtheta  Barnes Hut Optimize theta, double eg: -bhtheta 2.0 (default 1.2)");
            ...
            if( line.hasOption( "file" ) ) {
                ...
                System.out.println( line.getOptionValue( "file" ) );
                
                graphFile = line.getOptionValue( "file" ).trim();
                                
                if( line.hasOption( "linlogmode" ) ) {
                    String temp = line.getOptionValue( "linlogmode" ).trim();
                    if ( temp == "true"){
                        linlogmode = Boolean.TRUE;
                    }else if (temp == "false"){
                ...
                if( line.hasOption( "edgeweight" ) ) {
                    String temp = line.getOptionValue( "edgeweight" ).trim();
                    edgeweight = Double.parseDouble(temp);
                }else{
                    edgeweight = new Double(1.0);
                }
                
                if( line.hasOption( "scalingratio" ) ) {
                    String temp = line.getOptionValue( "scalingratio" ).trim();
                    scalingratio = Double.parseDouble(temp);
                }else{
                    scalingratio = new Double(4.0);
                }                
               
                
                if( line.hasOption( "stronggravity" ) ) {
                    String temp = line.getOptionValue( "stronggravity" ).trim();
                    
                    
                    if ( temp == "true"){
                        stronggravity = Boolean.TRUE;
                    }else if (temp == "false"){
                ...
                if( line.hasOption( "gravity" ) ) {
                    String temp = line.getOptionValue( "gravity" ).trim();
                    gravity = Double.parseDouble(temp);
                }else{
                    gravity = new Double(0.02);
                }                
               
                if( line.hasOption( "threads" ) ) {
                    String temp = line.getOptionValue( "threads" ).trim();
                ...
                if( line.hasOption( "bhoptimize" ) ) {
                    String temp = line.getOptionValue( "bhoptimize" ).trim();
                    if ( temp == "true"){
                        bhoptimize = Boolean.TRUE;
                    }else if (temp == "false"){
                        bhoptimize = Boolean.FALSE;
                    }else{
                        bhoptimize = Boolean.TRUE;
                    }                    
                }else{
                ...
                if( line.hasOption( "bhtheta" ) ) {
                    String temp = line.getOptionValue( "bhtheta" ).trim();
                    bhtheta = Double.parseDouble(temp);
                }else{
                    bhtheta = new Double(1.2);
                }                    
                
                
                
            }else{
                System.out.println( "Need to specify the file with -file path_to_file.gexf");
                System.exit(0);
            }
...
*/
        ...
        layout.setEdgeWeightInfluence(edgeweight);
        layout.setScalingRatio(scalingratio);
        layout.setStrongGravityMode(stronggravity);
        layout.setGravity(gravity);
        layout.setThreadsCount(threads);
        layout.setBarnesHutOptimize(bhoptimize);
        layout.setBarnesHutTheta(bhtheta);
